        ...
        >
            ...
            >
                ...
                <div className="md:w-[30%] p-6 md:p-8 flex flex-col justify-between overflow-y-auto">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-10 pt-6 border-t border-gray-100 dark:border-gray-700/50">
                        <a 
        ...
        >
            ...
            <div className="grid grid-cols-2 gap-2 mt-auto pt-4 border-t border-gray-100 dark:border-gray-700">
                <a 
                    ...
                    className="flex items-center justify-center gap-1.5 py-2 px-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-[10px] font-bold rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all"
                >
                ...
                {hasDemo && (
                    <a 
                        ...
                        rel="noopener noreferrer"
                        onClick={(e) => e.stopPropagation()}
                        className="flex items-center justify-center gap-1.5 py-2 px-3 bg-blue-600 text-white text-[10px] font-bold rounded-xl hover:bg-blue-700 transition-all shadow-md shadow-blue-500/20"
                    >
    ...
    const projectData = [
        {
            ...
            hasDemo: true,
            demoLink: 'https://interview-buddy-ai.netlify.app/',
            codeLink: 'https://github.com/RitikParihar09/Interview-buddy'
        },
        {
